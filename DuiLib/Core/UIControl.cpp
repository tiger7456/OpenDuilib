...
void CControlUI::SetItemStatusEx(int iStatus)
{
	m_iItemStatus = iStatus;
}

int CControlUI::GetItemStatusEx()
{
	return m_iItemStatus;
}
const CDuiString& CControlUI::GetItemStatusEx2()
{
	return m_sItemStatus;
}

void CControlUI::SetItemStatusEx2(LPCTSTR pstrText)
{
	m_sItemStatus = pstrText;
}
