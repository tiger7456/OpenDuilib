...
#import "PROGID:ShockwaveFlash.ShockwaveFlash"   raw_interfaces_only,/* Don't add raw_ to method names */ named_guids,/* Named guids and declspecs */    rename("IDispatchEx", "IMyDispatchEx") /* fix conflicting with IDispatchEx ant dispex.h */  rename("ICanHandleException", "IMyICanHandleException")
